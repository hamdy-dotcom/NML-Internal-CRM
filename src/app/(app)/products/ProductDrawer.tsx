          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "4px 16px" }}>
              ...
              {product.nml_category && (
                <div className="kv"><span className="k">NML Category</span><span dir="rtl">{product.nml_category}</span></div>
              )}
              {product.nml_subcategory && (
                <div className="kv"><span className="k">NML Subcategory</span><span dir="rtl">{product.nml_subcategory}</span></div>
              )}
              <div className="kv"><span className="k">Category (Salla)</span><span dir="rtl">{product.category || "—"}</span></div>
